...
| собака  |   |    dog    |   | червоний|   |   red   |`}
        ...
        <section>
          ...
          <p>
            На екрані тренування ви можете завантажити файл із реченнями-прикладами. Нові речення будуть додані до існуючих. Ви також можете очистити всю базу речень.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Увесь ваш прогрес (вивчені та невідомі слова) зберігається локально у вашому браузері. Якщо ви хочете почати вивчення словника з чистого аркуша, натисніть кнопку <strong>"Reset"</strong> у верхній частині екрану. Це видалить увесь збережений прогрес для поточного словника.
          </p>
        </section>
      </div>
    </Modal>
